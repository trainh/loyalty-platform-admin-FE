...
export default function User() {
  ...
  const [columnDefs, setColumnDefs] = useState([
    { field: 'id' },
    { field: 'loyaltyProgramId', filter: 'agNumberColumnFilter', maxWidth: 100 },
    { field: 'name' },
    {
      field: 'createdAt',
    ...
    { field: 'maxPoints', filter: 'agNumberColumnFilter' },
    { field: 'spendingValue', filter: 'adNumberColumnFilter' },
    { field: 'minPointsForRedemption', filter: 'adNumberColumnFilter' },
    { field: 'minRedeemablePoints', filter: 'adNumberColumnFilter' },
    { field: 'minRedeemableAmount', filter: 'adNumberColumnFilter' },
    { field: 'status' },
    { field: 'description' },
  ]);
